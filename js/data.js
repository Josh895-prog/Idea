// UniHaven Mock Data & Configuration

window.UNIVERSITIES = [
  { id: "metro-state", name: "Metro State University", city: "Main Campus", icon: "school" },
  { id: "tech-inst", name: "State Institute of Technology", city: "North Campus", icon: "cpu" },
  { id: "city-college", name: "City College & Medical School", city: "Downtown", icon: "activity" },
  { id: "westside-uni", name: "Westside University", city: "South Campus", icon: "book-open" },
];
...
window.INITIAL_LISTINGS = [
  ...
  },
  {
    ...
    description: "Ground floor bedsitter in a serene residential home compound. Beautiful green surroundings, paved walkways, and very close to Westside University main gate.",
